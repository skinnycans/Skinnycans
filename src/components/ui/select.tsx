  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 text-inherit transition-transform duration-300 group-data-[state=open]:rotate-180" />
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        'data-[state=checked]:bg-primary/10', // 👈 highlight the selected item
